...
<body>	
	...
	while(rs.next())
	{
		...
		ResultSet rs1=st1.executeQuery("SELECT * FROM tblfeedback WHERE Rating_data > 3	AND Shop_emailid = '"+emailid+"' AND Product_Name = '"+name+"'	ORDER BY Rating_data DESC limit 1");
		while(rs1.next())
		{
