...
<body>	
					...
					<div >
						<div >
							<div class="title text-center">
								<h1 class="mb-10 text-white">Show Product</h1>
								<br>
							</div>
							
							<form role="form" action="U_Show_Product.jsp" method="post">
	...
	ResultSet rs=st.executeQuery("select * from help_product_info where name='"+productname+"'");
	while(rs.next())
	{
...
%>
			...
			<td><a
														href="U_Ticket_Product_Feedback.jsp?id=<%=id%>"><input
															type="button" name="Download" value="View"
